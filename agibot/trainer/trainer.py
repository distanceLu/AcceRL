...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--seed", "-s", type=int, default=123, help="seed for seed_everything")
    parser.add_argument("--name", "-n", type=str, default="exp0", help="experiment name, as saving folder")
...
if __name__ == "__main__":
    ...
    logger_cfg = get_trainer_logger(lightning_config, workdir)
