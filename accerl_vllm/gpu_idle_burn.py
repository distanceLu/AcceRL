#!/usr/bin/env python3
"""Occupy visible GPUs with dummy memory allocation and compute work.

Examples:
  CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 python why_workspace/gpu_idle_burn.py
  CUDA_VISIBLE_DEVICES=0,1 python why_workspace/gpu_idle_burn.py --mem-frac 0.90
  python why_workspace/gpu_idle_burn.py --duration 600 --matmul-size 8192
"""
