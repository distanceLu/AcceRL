...
if __name__ == "__main__":
    ...
    t_c = "/cpfs01/zt_workspace/project/openvla_oft_rl/rl/policy_cpt/20260314_234740_openvla-7b+libero_spatial_no_noops+b32+lr-0.0005+lora-r32+dropout-0.0--image_aug--parallel_dec--8_acts_chunk--e599b39b7d/avg_success_rate-gte-0.300-step-500"
    ...
    cfg = GenerateConfig(
        ...
        # checkpoint2='/cpfs01/lcx_workspace/openvla-oft/runs/distill/20251225_113851_distill/checkpoints/checkpoint_latest.pt',
    )
