...
- 输入：`/mnt/data/lcx2/yanjieworkspace/data_collect/2026-08-13`
...
| `BRUSH_DATA_ROOT` | `/mnt/data/lcx2/yanjieworkspace/data_collect/<日期>` | 目录 | 包含各实验组和 `camera_paper_aruco` 的输入根目录 |
...
| `BRUSH_AUTO_SEARCH` | `1` | `0` 或 `1` | 首选帧/ROI 失败后，是否抽查其他帧并搜索垂直移动后的 ROI |
...
BRUSH_DATA_ROOT=/mnt/data/lcx2/yanjieworkspace/data_collect/2026-08-13 \
BRUSH_OUTPUT_ROOT=/mnt/data/lcx2/yanjieworkspace/AcceRL/outputs/my_brush_result \
bash tools/run_brush_contact_conversion.sh
```
...
```bash
BRUSH_PYTHON_BIN=/mnt/data/lcx2/yanjieworkspace/clone_env_smoke_test/rlinf_env/bin/python \
bash tools/run_brush_contact_conversion.sh
```
...
python tools/batch_brush_contact_distance.py \
  /mnt/data/lcx2/yanjieworkspace/data_collect/2026-08-13/10-10-10/camera_paper_aruco \
  --reference-frame 1 \
