...
#   默认值：<项目目录>/data_collect/$BRUSH_DATA_DATE
BRUSH_DATA_ROOT=${BRUSH_DATA_ROOT:-$BRUSH_PROJECT_ROOT/data_collect/$BRUSH_DATA_DATE}
...
环境超参数：
  ...
  BRUSH_AUTO_SEARCH      1 表示多帧/纵向 ROI 一致性搜索；0 表示关闭
