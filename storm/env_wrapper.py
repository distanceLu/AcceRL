...
class MetaWorldWrapper(gymnasium.Wrapper):
    def __init__(self, env, env_name, shape, sparse=False):
        super().__init__(env)
        self.observation_space = gymnasium.spaces.Box(low=0, high=255, shape=shape+(3,), dtype=np.uint8)
        self.sparse = sparse
    ...
    def reset(self, **kwargs):
        ...
        # info["intruction"] = METAWORLD_INSTRUCTIONS[self.env_name]
        return image, info
